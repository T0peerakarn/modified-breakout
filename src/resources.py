...
gSounds = {
    ...
    'multiple': pygame.mixer.Sound('sounds/multiple.mp3'),
    'ultimate': pygame.mixer.SoundType('sounds/ultimate.mp3'),
}
...
items_image_list = {
  ITEM_DISPERSE: sprite_collection["item_disperse"].image,
  ITEM_MULTIPLE: sprite_collection["item_multiple"].image,
  ITEM_HEART: sprite_collection["item_heart"].image,
}
